            ...
            <div class="navbar-nav flex-row order-md-last">
                ...
                <div class="nav-item dropdown ms-3">
                    <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                        ...
                        <span class="avatar avatar-sm" style="background-image: url({{ $ruta_foto_usua }})"></span>
            ...
            <div class="navbar">
                <div class="container-xl">
                    <ul class="navbar-nav">
                        ...
                        {{-- <li class="nav-item dropdown {{ request()->routeIs('configuracion*') ? 'active' : '' }}">
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-menu-columns">
                                    <div class="dropdown-menu-column">
                                        <a class="dropdown-item {{ request()->routeIs('configuracion.areas') ? 'active' : '' }}" href="{{ route('configuracion.areas') }}">
                                            Área
                                        </a>
                                        <a class="dropdown-item {{ request()->routeIs('configuracion.beneficios') ? 'active' : '' }}" href="{{ route('configuracion.beneficios') }}">
                                            Beneficios
                                        </a>
                                        <a class="dropdown-item {{ request()->routeIs('configuracion.modalidad') ? 'active' : '' }}" href="{{ route('configuracion.modalidad') }}">
                                            Modalidad
                                        </a>
                                    </div>
                                </div>
